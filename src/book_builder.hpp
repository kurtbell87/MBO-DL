...
private:
    ...
    static constexpr uint64_t NS_PER_HOUR = 3600ULL * NS_PER_SEC;
    static constexpr uint64_t NS_PER_DAY  = 24ULL * NS_PER_HOUR;
    // 2022-01-03 00:00:00 ET in UTC nanoseconds
    static constexpr uint64_t REF_MIDNIGHT_ET_NS = 1641186000ULL * NS_PER_SEC;

    static uint64_t midnight_et_ns(uint64_t ts) {
