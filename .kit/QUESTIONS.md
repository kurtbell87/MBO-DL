...
| Does temporal signal emerge on tick bars, at actionable timescales (≥5s), or at extended horizons (17-83min)? | REFUTED | 0/54+ dual passes across tick_50/100/250, time_5s h=200/500/1000. All AR R² negative. MES is martingale across all bar types and timescales 5s-83min. | `.kit/results/temporal-predictability-completion/analysis.md` (R4c) |
