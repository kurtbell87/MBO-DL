...
| P0 | Is the two-stage expectancy at 19:7 genuinely positive under corrected hold-bar PnL ($0 for hold-bar trades)? | Not started | 2-class formulation | — | Resolves 8x uncertainty in reported $3.78/trade. Corrected estimate ~$0.44 ± $0.16 — the go/no-go for 19:7 geometry exploitation. | — |
