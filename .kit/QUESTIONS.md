...
| P1 | Does a 2-class formulation (directional-vs-hold) at 19:7 enable high-ratio geometry exploitation? | Not started | — | — | Model's strength is barrier-reachability detection (volatility features), weakness is direction. 2-class decoupling may convert hold-prediction tendency into a useful filter. | — |
