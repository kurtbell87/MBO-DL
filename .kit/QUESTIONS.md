...
| P0 | Does XGBoost at high-ratio geometries (15:3, 19:7, 20:3) achieve positive expectancy using long-perspective labels? | Not started | — | — | Bidirectional labels degenerate (91-99% hold on time_5s). Must verify long-perspective labels produce balanced distributions at varied geometries, then re-run geometry sweep. | — |
