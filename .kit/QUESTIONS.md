...
| P2 | Does volume-flow conditioned entry (enter during high-volume periods) reduce timeout fraction below 41% and improve per-trade expectancy? | Not started | — | — | Timeout fraction invariant at 41.3% across all time-of-day cutoffs — timeouts driven by volume horizon, not clock. Volume-flow conditioning targets the actual mechanism. | — |
